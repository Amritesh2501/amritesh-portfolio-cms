...
export const RESOURCES: ResourceDef[] = [
  {
    ...
    fields: [
      ...
      { name: "longBio", label: "Long bio", type: "markdown", wide: true, section: "About" },
      {
        ...
        label: "Date of birth",
        type: "date",
        help: "Shown in the diary in the room through the book, and nowhere else.",
        section: "The diary",
      },
      {
        name: "hobbies",
        ...
        type: "list",
        wide: true,
        help: "One per line. What he does when nobody is paying him to do it.",
        section: "The diary",
      },
      {
        name: "diaryNote",
        ...
        type: "markdown",
        wide: true,
        help: "A page in his own voice. The only thing on this site written as if nobody were reading it.",
        section: "The diary",
      },
      {
        name: "philosophy",
